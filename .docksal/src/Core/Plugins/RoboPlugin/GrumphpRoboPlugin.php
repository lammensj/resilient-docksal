...
class GrumphpRoboPlugin extends AbstractRoboPlugin implements RoboPluginDownloaderInterface
{
    ...
    public function download(): array
    {
        ...
        if (file_exists($grumphpDir)) {
            ...
            $tasks[] = $this->taskExec(sprintf('%s/vendor/bin/grumphp git:deinit', $this->configFactory->get('project_root')));
            $tasks[] = $this->taskExec(sprintf('%s/vendor/bin/grumphp git:init', $this->configFactory->get('project_root')));
        }
